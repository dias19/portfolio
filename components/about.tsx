      ...
      <section className={style.section}>
        <div>
          ...
          <p className={style.body}>
            Hello! My name is Dias and I enjoy creating things that live on the
          ...
          <ul className={style.list}>
            <li className={style.listItem}>Javascript (ES6+)</li>
            <li className={style.listItem}>Typescript</li>
            <li className={style.listItem}>React</li>
